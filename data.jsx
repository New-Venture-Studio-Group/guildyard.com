...
const GY_ARTICLES = [
  ...
  { id: "cheap-evidence", title: "Cheap evidence first", kind: "Field note", category: "Market evidence", date: "18 December 2025", iso: "2025-12-18", read: "7 min read",
    lede: "Rank the questions by what it costs to answer them, then answer the cheap ones in public." },
  { id: "stop-rule", title: "The stop rule you write before you start", kind: "Essay", category: "Decision making", date: "02 December 2025", iso: "2025-12-02", read: "10 min read",
    lede: "Deciding when to stop is a design problem, and it is much easier to solve before there is anything to defend." },
  { id: "one-page", title: "One page, or it isn't a plan", kind: "Field note", category: "Operating systems", date: "14 November 2025", iso: "2025-11-14", read: "4 min read",
    lede: "Length is a proxy for unresolved thinking. The page limit does the arguing for you." },
  { id: "audience-of-one", title: "An audience of one is still an audience", kind: "Essay", category: "Venture building", date: "29 October 2025", iso: "2025-10-29", read: "8 min read",
